...
import { UPDATE_USER_INFO } from "../../Constants/PathConstants"

export default function DoctorProfile() {
  const {username, userEmail, userDob, userid, userSpeciality} = React.useContext(UserContext);
            ...
            <div className="card-body">
              <form className="form-sample">
                ...
                <div className="row">
                  <div className="col-md-12">
                    <Form.Group className="row form-horizontal" style={{alignItems:'center'}}>
                      <label className="col-sm-3 col-form-label">Speciality</label>
                      <div className="col-sm-3" style={{height:'min-content'}}>
                        <span style={{fontSize:"80%"}}>{userSpeciality}</span>
                      </div>
                    </Form.Group>
                  </div>
                </div>
